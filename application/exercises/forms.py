...
class ExerciseEditForm(FlaskForm):
    name = StringField("Korvaava nimi", [validators.optional(), validators.Length(max=144)])
    description = StringField("Korvaava kuvaus", [validators.optional(), validators.Length(max=144)])
    unit = NewRadioField('Korvaava toistoissa käytetty yksikkö', choices=[('kg','Kilogramma'),('min','Minuutti'),('sec', 'Sekunti'),('m', 'Metri'),('km', 'Kilometri')])
