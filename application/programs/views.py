...
from application.programs.forms import (ProgramForm,
                                        ProgramFilterForm,
                                        ProgramAddWorkoutForm,
...
def programs_index():
    ...
    return render_template("programs/list.html",
                           ...
                           active_program_name=current_user
                           .get_active_program_name())
...
def programs_edit(program_id):   
    ...
    wos = Workouts.query.filter_by(
        program_id=program_id).order_by('date_created')
    ...
    exerciseform.exercise.choices = [(g.id, g.name) for g in
                                     Exercises.query.all()]

    return render_template("programs/edit.html",
                           program=p,
                           workoutform=ProgramAddWorkoutForm(),
                           workouts=wos,
